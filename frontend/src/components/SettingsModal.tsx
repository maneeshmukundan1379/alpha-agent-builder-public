          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Enter the repo URL on each check-in. Put <code className="text-cyan-200/80">GITHUB_TOKEN=...</code> in{" "}
                <span className="text-slate-200">Create/Edit Environment file</span>; check-in uses that token only.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-1 text-xs text-slate-500">
                Environment keys: <span className="text-slate-400">Create/Edit Environment file</span> on the builder.
              </p>
              <button
